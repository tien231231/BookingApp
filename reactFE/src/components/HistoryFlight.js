...
import "../styles/HistoryFlight.css";
          ...
          <div className="HistoryFlight-item" key={index}>
            <div className="HistoryFlight-item-detail">
              ...
              <div className="HistoryFlight-item-detail-time">
                <div>
                  <div style={{ color: "gray" }}>{data.flight.cityFrom}</div>
                  <h3 style={{ marginTop: "6px", marginBottom: "0" }}>
                    {dayjs(data.flight.local_departure).format("HH-mm-ss")}
                  </h3>
                </div>
                <svg
                  width="20"
                ...
                <div>
                  <div style={{ color: "gray" }}>{data.flight.cityFrom}</div>
                  <h3 style={{ marginTop: "6px", marginBottom: "0" }}>
                    {dayjs(data.flight.local_arrival).format("HH-mm-ss")}
                  </h3>
                </div>
              </div>
              ...
              <div className="HistoryFlight-item-detail-plane">
                <div className="detail-plane">
                  ...
                  <div>
                    ...
                    <h4 style={{ margin: "0" }}>
                      {dayjs(data.flight.local_arrival).format("DD-MM-YYYY")}
                    </h4>
                  </div>
                </div>
                <div className="detail-plane">
                  ...
                  <div>
                    ...
                    <h4 style={{ margin: "0" }}>{data.flight.flightTime}</h4>
                  </div>
                </div>
                <div className="detail-plane">
                  <svg
                  ...
                  <div>
                    ...
                    <h4 style={{ margin: "0" }}>{data.flight.gate}</h4>
                  </div>
                </div>
                <div className="detail-plane">
                  <svg
                  ...
                  <div>
                    ...
                    <h4 style={{ margin: "0" }}>{data.flight.seatNo}</h4>
                  </div>
                </div>
              </div>
            </div>
